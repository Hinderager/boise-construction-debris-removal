...
const SITE_NAME = 'Boise Construction Debris Removal'
const SITE_URL = 'https://boise-construction-debris-removal.com'
const SITE_PHONE = '+1-208-943-5231'
const SERVICE_NAME = 'Construction Debris Removal Services'
    ...
    image: [
      {
        ...
        name: 'Construction Debris Removal Services in the Treasure Valley',
        caption: 'Boise Construction Debris Removal crew at work in Meridian, Idaho',
        contentLocation: {
          '@type': 'Place',
          name: 'Meridian, Idaho',
          geo: { '@type': 'GeoCoordinates', latitude: 43.6055, longitude: -116.3817 },
        },
      },
    ],
    aggregateRating: {
